...
//        System.out.println(improvedTuple.process(19L));
        ...
        Triple<Double, Long, Long> differentTriple = new Triple<>(0.35, 0L, System.currentTimeMillis());
        System.out.println(triple.getBody().toString()); // Should be overriden toString from SuperClass!
        System.out.println(differentTriple.getIndex() + "---" + differentTriple.getBody() + "---" + differentTriple.process(0.35));
